[0;34m[INFO][0m Applying dev domain styles to navbar (desktop)
/**
      ...
      <nav class="navbar-desktop" id="desktop-navbar-component">
        <div class="navbar-container">
          ...
          <div class="navbar-nav">
            <a href="/dev/" class="nav-link">Home</a>
            <a href="/dev/about" class="nav-link">About</a>
            <a href="/dev/courses" class="nav-link">Courses</a>
            <a href="/dev/resources" class="nav-link">Resources</a>
            <a href="/dev/community" class="nav-link">Community</a>
            <a href="/dev/contact" class="nav-link">Contact</a>
          </div>
