[0;34m[INFO][0m Applying server domain styles to footer (desktop)
/**
          ...
          <div class="footer-content">
            ...
            <div class="footer-column">
              ...
              <ul class="footer-links">
                ...
                <li><a href="/server/blog" class="footer-link">Blog</a></li>
            ...
            <div class="footer-column">
              ...
              <ul class="footer-links">
                <li><a href="/server/gremlingpt" class="footer-link">GremlinGPT AI System</a></li>
                ...
                <li><a href="/server/self-hosting" class="footer-link">Self-Hosting Solutions</a></li>
                <li><a href="/server/consulting" class="footer-link">Technical Consulting</a></li>
                <li><a href="/server/workshops" class="footer-link">Workshops & Training</a></li>
              </ul>
            </div>
            ...
            <div class="footer-column">
              ...
              <ul class="footer-links">
                ...
                <li><a href="/server/api" class="footer-link">API Reference</a></li>
                <li><a href="/server/faq" class="footer-link">FAQ</a></li>
                <li><a href="/server/status" class="footer-link">Service Status</a></li>
                <li><a href="/server/changelog" class="footer-link">Changelog</a></li>
              </ul>
            </div>
          ...
          <div class="footer-bottom">
            <div class="footer-bottom-left">
              ...
              <div class="footer-legal">
                <a href="/server/privacy" class="footer-legal-link">Privacy Policy</a>
                <span class="footer-separator">•</span>
                <a href="/server/terms" class="footer-legal-link">Terms of Service</a>
                <span class="footer-separator">•</span>
                <a href="/server/cookies" class="footer-legal-link">Cookie Policy</a>
              </div>
            </div>
